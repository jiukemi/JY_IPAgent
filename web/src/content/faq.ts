...
export const FAQ_ITEMS: FaqItem[] = [
  ...
  },
  {
    ...
    a:
      ...
      + '处理：① 升到 0.1.40+；② 设置 → 特殊引擎安装 → 本机环境 → IndexTTS2 点「重装 / 修复」（缺项旁也有「修复此项」）；③ 任务中心对失败/未就绪安装可「重新排队」。权重加速包不能替代完整安装。',
  },
  {
    id: 'indextts-install-stuck',
    q: 'IndexTTS 安装结束但提示未就绪，任务中心没了、也没有重装按钮？',
    a:
      '旧版会把「脚本跑完但缺源码」标成完成，历史里不能重新排队；缺失列表也没有修复入口。\n'
